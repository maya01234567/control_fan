...
esp_http_client_handle_t esp_http_client_init(const esp_http_client_config_t *config)
{
    ...
    _success = ((client = calloc(1, sizeof(esp_http_client_t))) &&
    ...
    _success = ((client->transport_list = esp_transport_list_init()) &&
    ...
    _success = ((ssl = esp_transport_ssl_init()) &&
    ...
    _success = ((client->request->buffer->data = malloc(client->buffer_size_tx)) &&
    ...
    {
        _success = ((esp_http_client_set_header(client, "User-Agent", user_agent) == ESP_OK) &&
    ...
    {
        _success = ((esp_http_client_set_url(client, config->url) == ESP_OK) &&
...
esp_err_t esp_http_client_set_url(esp_http_client_handle_t client, const char *url)
{
    ...
    if (old_host && client->connection_info.host && strcasecmp(old_host, (const void *)client->connection_info.host) != 0)
    {
